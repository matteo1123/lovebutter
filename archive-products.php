				...
				<?php while(have_posts()) {
					the_post();?>
							<a class="no-underline" href="<?php echo the_permalink(); ?>">
								<div style="min-height:300px; display:flex; margin-bottom:20px;" class="btn btn-outline-secondary container-fluid row">
									<div class="col-xl-8 dont-underline">
										<h2 class="text-left pt-5 font-weight-bold"><?php echo the_title(); ?></h2>
										<h3 class="pt-5 my-5"><?php echo the_field('preview_text', get_the_ID());?></h3>
										<h2 class="text-right py-5 font-weight-bold"><?php echo the_field('price', get_the_ID());?></h2>
									</div>
									<div class="col-xl-4">
